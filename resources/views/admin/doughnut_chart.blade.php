 ...
 <script src="{{ asset('admin_assets/vendor/chart/Chart.min.js') }}"></script>
 ...
 <!-- custom js  -->
 <script language="JavaScript" type="text/javascript" src="{{ asset('admin_assets/vendor/chart/custom/custom.js') }}">
 </script>

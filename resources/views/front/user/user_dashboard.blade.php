...
<body>
    ...
    <div class="container bg-dark">
        <div class="row d-flex justify-content-between px-1 py-1">
            <a href="{{ url('/') }}" class="text-light btn btn-primary">Home Page</a>
            <a href="{{ url('/donate/user/logout') }}" class="text-light btn btn-danger">Log out</a>
        </div>
    </div>
    <!--  nav end -->
    <section class="mt-5">
